...
export class Group extends BaseItem {
    ...
    constructor(id: string, title?: string, createDate?: Date, modifyDate?: Date, flags: any = { isEditable: true, isRemovable: true, isHidden: false,isAutoGenerated: false,isReadOnly: false }) {
