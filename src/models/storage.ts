...
let _defaultGroup = new Group("default_group", get(_)("nav.all_items"), undefined, undefined, { isEditable: false, isRemovable: false, isHidden: false,isAutoGenerated:true });
let _searchGroup = new Group("search_group", get(_)("nav.search_results"), undefined, undefined, { isEditable: false, isRemovable: false, isHidden: true,isAutoGenerated:true,isReadOnly:true });
...
const group: IGroupModel =
{
    ...
    getAll: () => get(storage).filter((group: Group) => !group.flags.isAutoGenerated),
